  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{ backgroundColor: "#08090a" }}>
      <div className="max-w-md w-full text-center space-y-5">
        ...
        <Link href="/" className="inline-flex h-9 px-4 rounded-lg text-white text-sm font-medium items-center gap-2 transition-colors" style={{ backgroundColor: "#5e6ad2", fontWeight: 510 }} onMouseEnter={(e)=>(e.currentTarget.style.backgroundColor="#828fff")} onMouseLeave={(e)=>(e.currentTarget.style.backgroundColor="#5e6ad2")}><Search className="w-4 h-4"/> Go to Dashboard</Link>
      </div>
    </div>
  );
}
